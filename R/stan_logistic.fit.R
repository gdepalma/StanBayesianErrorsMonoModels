...
stan_logistic.fit <- function(dat_sav,xgrid,nchains=1,numIter=500,xsig=.707, ysig=2.121) {
  ...
  fit <- rstan::sampling(stanfit, pars = c("MIC_Dens","gx"),data = dat, iter = numIter,chains = nchains,thin=2,init=init_fun,
